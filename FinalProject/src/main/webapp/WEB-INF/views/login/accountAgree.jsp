...
<script>
	function agreeChk(f) {
		...
		if (chk1 == "") {
			alert('실보미 이용약관에 동의하셔야합니다.');
			return false;
		}

		if (chk2 == "") {
			alert('개인정보 수집 및 이용약관에 동의하셔야합니다.');
			return false;
		}
		
		location.href='./account?user_type=${param.user_type}';
	}
</script>
...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div align="center">
		<div id="accordion" style="width: 100%">
			<form name="agreeFrm" action="./account?user_type=${param.user_type }" method="post"
				onsubmit="return agreeChk(this)">
				<table style="width: 100%;">
					<tr>
						<td align="center">
							<div style="margin-top: 45px;" style="border:1px solid black;"></div>
							<h2 style="color: gray;">가입 약관 동의</h2> <br />
							<div>
								<a href="#"> <font size="4">실보미 이용약관 동의(필수)</font>&nbsp;&nbsp;<input
									type="checkbox" name="chk1" id="c1" />
								</a> <br />
								<textarea readonly="readonly" rows="5" cols="66">
제 1 조 (목적)

이 약관은 실보미("회사" 또는 "실보미")가 제공하는 실보미 및 실보미 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.


제 2 조 (정의)

이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 실보미 및 실보미 관련 제반 서비스를 의미합니다.
...
⑦"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.  
					...
					<tr>
						<td align="center">
							<div>
								<a href="#"> <font size="4">개인정보 수집 및 이용에 대한 안내(필수)</font>&nbsp;&nbsp;<input
									type="checkbox" name="chk2" id="c2" />
								</a> <br />
								<textarea readonly="readonly" rows="5" cols="66">
정보통신망법 규정에 따라 실보미에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.


1. 수집하는 개인정보

이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 실보미 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 실보미는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
					...
					<tr>
						<td align="center">
							<div>
								<a href="#"> <font size="4">위치정보 이용약관 동의(선택)</font>&nbsp;&nbsp;<input
									type="checkbox" name="chk3" id="c3" />
								</a> <br />
								<textarea readonly="readonly" rows="5" cols="66">
						
위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 실보미 위치기반 서비스를 이용할 수 있습니다.


제 1 조 (목적)
이 약관은 실보미 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
6. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.
					...
					<tr>
						<td align="center"><font size="3">이벤트 등 프로모션 알림 메일
								수신(선택)</font>&nbsp;&nbsp;<input type="checkbox" name="chk4" id="c4">
						</td>
					</tr>
				</table>
				<div align="center">
					<br />
					<button type="button" class="btn btn-primary" onclick="agreeChk(this);">동의</button>
					&nbsp;&nbsp;
					<button type="button" onclick="location.href='/silbomi/main';"
						class="btn btn-outline-dark">비동의</button>
					<br />
				</div>
			</form>
		</div>
	...
	<!-- 	       		<div id="accordion" style="width:100%"> -->
	<!-- 					<form name="agreeFrm" action="./account" method="post" onsubmit="return agreeChk(this)"> -->
	<!-- 						<table style="width:100%; "> -->
	<!-- 						<tr> -->
	<!-- 							<td align="center"> -->
	<!-- 								<div style="margin-top:45px;" style="border:1px solid black;"></div> -->
	<!-- 								<h2 style="color:gray;">가입 약관 동의</h2> -->
	<!-- 								<br /> -->
	<!-- 								<div> -->
	<!-- 									<a href="#"> -->
	<!-- 										<font size="4">실보미 이용약관 동의(필수)</font>&nbsp;&nbsp;<input type="checkbox" name="chk1" id="c1"/> -->
	<!-- 									</a> -->
	<!-- 									<br /> -->
	<!-- 									<textarea readonly="readonly" rows="5" cols="66" > -->
	<!-- 제 1 조 (목적) -->
	...
	<!-- 									<div> -->
	<!-- 										<a href="#"> -->
	<!-- 											<font size="4">개인정보 수집 및 이용에 대한 안내(필수)</font>&nbsp;&nbsp;<input type="checkbox" name="chk2" id="c2" /> -->
	<!-- 										</a> -->
	<!-- 										<br /> -->
	<!-- 										<textarea readonly="readonly" rows="5" cols="66"> -->
	<!-- 정보통신망법 규정에 따라 실보미에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다. -->
	...
	<!-- 									<div> -->
	<!-- 										<a href="#"> -->
	<!-- 											<font size="4">위치정보 이용약관 동의(선택)</font>&nbsp;&nbsp;<input type="checkbox" name="chk3" id="c3" /> -->
	<!-- 										</a> -->
	<!-- 										<br /> -->
	<!-- 										<textarea readonly="readonly" rows="5" cols="66"> -->
	...
	<!-- 							<tr> -->
	<!-- 								<td align="center"> -->
	<!-- 									<font size="3">이벤트 등 프로모션 알림 메일 수신(선택)</font>&nbsp;&nbsp;<input type="checkbox" name="chk4" id="c4"> -->
	<!-- 								</td> -->
	<!-- 							</tr> -->
	<!-- 						</table> -->
	<!-- 					<div align="center"> -->
	...
	<!-- 						&nbsp;&nbsp; -->
	<!-- 						<button type="button" onclick="location.href='/silbomi/main';" class="btn btn-outline-dark">비동의</button> <br /> -->
	<!-- 					</div> -->
	<!-- 				</form> -->
